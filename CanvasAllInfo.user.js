...
// @namespace    https://github.com/maccorehenni
// @version      1.0.0
// @icon         https://canvas.instructure.com/favicon.ico
// @copyright    2020-2021, Daniel Lau (orignal); 2022, Mac Henni and others (improvements)
// @license      MIT
...
/*
  thanks to Mr. Lau from Userscriptzone (original)
  Note:
...
load();
/*end original, start improvements
thanks to melvas on Stack Overflow for this improvement (change title to "Dashboard")*/
var x=document.getElementsByClassName("mobile-header-title"); // Find the elements
    for(var i = 0; i < x.length; i++){
    x[i].innerText="Dashboard";    // Change the content
    }
/* thanks to Paul Bui on Greasyfork (buttons on top)*/
'use strict';
  ...
  if (wrapper)
  {
      ...
      for (let courseStr in courseNumDict)
      {
          ...
          newA.setAttribute("class", "btn btn-primary class_button");
